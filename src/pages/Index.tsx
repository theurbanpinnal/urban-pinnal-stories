            ...
            {!fetchingCollections && featuredCollections.length > 0 && (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {featuredCollections.map(({ node: collection }) => (
                  ...
                  >
                    <div 
                      className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition-all duration-300 group cursor-pointer border-2 hover:border-craft-terracotta/30 border-transparent"
                    >
